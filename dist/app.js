...
function createView(name, Class) {
    var View = document.registerElement(name, Class);
    return function (params) {
        return (0, _assign2.default)(new View(), params);
    };
}

function createTemplate(html) {
    var t = new DOMParser().parseFromString(html, 'text/html');
    var template = t.head.firstChild.content;
...
var _views = __webpack_require__(115);
...
var req = __webpack_require__(399);
req.keys().map(req);
...
var App = function (_HTMLElement) {
    ...
    (0, _createClass3.default)(App, [{
        ...
        value: function attachedCallback() {
            ...
            var content = (0, _views.createTemplate)(_app2.default);
...
var _gear = __webpack_require__(392);

var _gear2 = _interopRequireDefault(_gear);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Gear = function (_HTMLElement) {
    (0, _inherits3.default)(Gear, _HTMLElement);
    ...
    (0, _createClass3.default)(Gear, [{
        key: 'attachedCallback',
        value: function attachedCallback() {
            var content = (0, _views.createTemplate)(_gear2.default);
            this.appendChild(content);
        }
    }]);
    return Gear;
...
exports.default = (0, _views.createView)('machina-gear', Gear);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(123)(Function.call, __webpack_require__(128).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch(e){ buggy = true; }
      return function setPrototypeOf(O, proto){
...
$export($export.S + $export.F * !__webpack_require__(33), 'Object', {defineProperty: __webpack_require__(36).f});
...
module.exports = "<template data-component=\"app\">\n    <div class=\"machine-box\">\n        <machina-gear></machina-gear>\n        <machina-gear reverse></machina-gear>\n        <machina-gear></machina-gear>\n    </div>\n    <div class=\"machine-controls\">\n        <label class=\"toggle\">\n            <input type=\"checkbox\" id=\"ignition\"><span></span>\n            <span>Run</span>\n        </label>\n    </div>\n</template>\n";

/***/ }),
/* 392 */
/***/ (function(module, exports) {

module.exports = "<template data-component=\"word\">\n    <svg>\n        <use xlink:href=\"#icon-gear\"></use>\n    </svg>\n</template>\n";
...
var Sprite = __webpack_require__(397);
...
var Sniffr = __webpack_require__(394);
